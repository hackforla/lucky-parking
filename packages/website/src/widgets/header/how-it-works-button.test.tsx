...
describe("Modal and click modal trigger", () => {
  ...
  test("renders description", () => {
    ...
    expect(ele.textContent).toEqual('Parking Insights lets you get data on Los Angeles parking tickets data on Los Angeles parking tickets using several options:') 
  });
  ...
  test("renders SearchIcon's second list text", () => {
    ...
    expect(ele.textContent).toEqual('Search for a Neighborhood Council District or Zip Code to get data for that region') 
  })
